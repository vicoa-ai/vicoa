...
/// Apply an app UI language preference ('system' | 'en' | 'zh'): persist it and
/// switch the live locale immediately. Mirrors [setDarkModeSetting].
void setLanguageSetting(BuildContext context, String pref) {
  final code = resolveAppLanguageCode(pref);
  FFAppState().setAppLanguagePref(pref);
